...
public class Maths {
    ...
    public static float sampleNoise2D(int x, int z, float simplexSampleRate) {
        return (float) NOISE.getValue((((float)x + simplexSampleRate) / simplexSampleRate), (((float)z + simplexSampleRate) / simplexSampleRate));
    }

    public static float sampleNoise3D(int x, int y, int z, float simplexSampleRate) {
        return (float) NOISE.getValue((((float)x + simplexSampleRate) / simplexSampleRate), (((float)y + simplexSampleRate) / simplexSampleRate), (((float)z + simplexSampleRate) / simplexSampleRate));
    }
